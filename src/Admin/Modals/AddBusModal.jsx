...
const AddBusModal = (props) => {
    ...
    const handleFormNext = () => {
        let nextFlag = true;
        if (formNo === 1) {
            let form = document.querySelector('.bus-form1').getElementsByTagName("input");
            for (let i of form) {
                // console.log(i);
    ...
    const handleSubmit = async (e) => {
        ...
        let ans = await context.createBus(data.busName, data.source, data.destination, stationArr, data.busSeats, data.busWindowSeats, data.busSpeed, [], data.busFare, data.busStartTime, data.busDistance, data1);
        console.log(ans);
        if (ans.success) {
    ...
    return (
        <>
            <div id="addBusModal" tabIndex="-1" className="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
                                    ...
                                    <div className={formNo === 1 ? "bus-form1" : "bus-form1 hidden"}>
                                        ...
                                        <div className="grid gap-6 px-0.5 py-0.5 mb-6 md:grid-cols-2 admin-form">
                                            ...
                                            <div>
                                                ...
                                                <input type="number" id="busSpeed" name='busSpeed' className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Average speed of bus" onChange={handleChange} value={data.busSpeed} />
                                            </div>
                                            <div>
                                            ...
                                            {data2.map((e, index) => {
                                                return (
                                                    <div key={index} className="flex mb-2">
                                                        ...
                                                        <div className='w-full mr-2'>
                                                            <input type="number" id="distance" name='distance' className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Trip distance" onChange={(e) => {
                                                                handleChange2(e, index);
                                                            }} value={data2[index].distance} />
                                                        </div>
                                                        <div className='w-full mr-2'>
                                                            <input type="number" id="fare" name='fare' className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Trip fare" onChange={(e) => {
                                                                handleChange2(e, index);
                                                            }} value={data2[index].fare} />
                                                        </div>
                                                        <div className='w-full mr-2'>
                                                            <input type="datetime-local" id="time" name='time' className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Arrival time" onChange={(e) => {
                                                                handleChange2(e, index);
